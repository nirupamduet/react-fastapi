...
//  TS(6142): Module './styles' was resolved to 'C:/Users/nirupa... Remove this comment to see the full error message
...
const ToolbarContent = styled("div")(({ color }) => ({
  ...
  //  TS(2538): Type 'undefined' cannot be used as an index type.
