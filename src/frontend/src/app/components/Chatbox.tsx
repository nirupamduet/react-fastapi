...
//  TS(2307): Cannot find module 'app/utils/utils' or its corres... Remove this comment to see the full error message
  ...
  const sendMessageOnEnter = (event: any) => {
    if (event.key === "Enter" && !event.shiftKey) {
      ...
      if (tempMessage !== "") {
        ...
        //  TS(2345): Argument of type '{ text: string; contactId: strin... Remove this comment to see the full error message
    ...
    <ChatContainer>
      ...
      <StyledScrollBar id="chat-scroll">
        {messageList.map((item, ind) => (
          ...
          <Box
            ...
            //  TS(2339): Property 'contactId' does not exist on type 'never... Remove this comment to see the full error message
            ...
            <Box ml="12px">
              ...
              {currentUserId !== item.contactId && (
                ...
                <H5 mb={0.5} fontSize={14} color={primary}>
                  //  TS(2339): Property 'name' does not exist on type 'never'.
                  {item.name}
                </H5>
              )}
      ...
      <div>
        ...
        <TextField
          multiline
          fullWidth
          //  TS(2322): Type '{ multiline: true; fullWidth: true; rowsMax:... Remove this comment to see the full error message
          rowsMax={4}
          value={message}
