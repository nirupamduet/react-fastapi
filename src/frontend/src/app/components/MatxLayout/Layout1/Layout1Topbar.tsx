...
//  TS(2307): Cannot find module 'app/components/ShoppingCart' o... Remove this comment to see the full error message
...
//  TS(2307): Cannot find module 'app/components/NotificationBar... Remove this comment to see the full error message
