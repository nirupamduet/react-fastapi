...
export const NotificationProvider = ({
  ...
  return (
    <NotificationContext.Provider
      value={{
        getNotifications,
        // @ts-expect-error TS(2322): Type '(notificationID: any) => Promise<void>' is n... Remove this comment to see the full error message
        deleteNotification,
        clearNotifications,
        // @ts-expect-error TS(2322): Type '(notification: any) => Promise<void>' is not... Remove this comment to see the full error message
        createNotification,
