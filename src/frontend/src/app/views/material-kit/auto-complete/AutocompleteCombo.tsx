...
export default function AutocompleteCombo() {
  ...
  const handleChange = (_: any, newValue: any) => {
    if (newValue && newValue.inputValue) {
      //  TS(2345): Argument of type '{ label: any; }' is not assignab... Remove this comment to see the full error message
  ...
  return (
    ...
    <Fragment>
      ...
      <AutoComplete
        ...
        //  TS(2339): Property 'label' does not exist on type 'HTMLAttri... Remove this comment to see the full error message
