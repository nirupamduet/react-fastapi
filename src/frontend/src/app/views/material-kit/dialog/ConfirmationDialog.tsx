...
function ConfirmationDialogRaw(props: any) {
  ...
  function handleEntering() {
    if (radioGroupRef.current !== null) {
      //  TS(2339): Property 'focus' does not exist on type 'never'.
    ...
    <DialogRoot>
      ...
      <List component="div" role="list">
        ...
        <ConfirmationDialogRaw
          //  TS(2322): Type '{ keepMounted: true; open: boolean; value: s... Remove this comment to see the full error message
          keepMounted
          open={open}
          value={value}
          className="paper"
