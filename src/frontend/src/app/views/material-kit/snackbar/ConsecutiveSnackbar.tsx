...
const ConsecutiveSnackbars = () => {
  ...
  const handleClick = (message: any) => () => {
    //  TS(2345): Argument of type '(state: never[]) => { message: a... Remove this comment to see the full error message
  ...
  const processQueue = () => {
    if (queue.length > 0) {
      //  TS(2345): Argument of type 'undefined' is not assignable to ... Remove this comment to see the full error message
  ...
  return (
    ...
    <Box>
      ...
      <Snackbar
        open={open}
        //  TS(2339): Property 'key' does not exist on type '{}'.
        key={messageInfo.key}
        onClose={handleClose}
        autoHideDuration={6000}
        //  TS(2322): Type '{ open: boolean; key: any; onClose: (_: any,... Remove this comment to see the full error message
