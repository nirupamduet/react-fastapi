...
//  TS(2307): Cannot find module 'app/components/MatxLogo' or it... Remove this comment to see the full error message
import MatxLogo from "app/components/MatxLogo";
//  TS(2307): Cannot find module 'app/components/MatxDivider' or... Remove this comment to see the full error message
